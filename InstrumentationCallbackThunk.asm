...
InstrumentationCallbackThunk proc
	...
	mov     rcx, rsp				  ;Setup RCX for RtlCaptureContext call
...
;TODO: Writeup hook to store never overwrite R10 and instead use TEB locations to restore calling registers
;aka RCX -- Would this cause threading issues? Why do they INSIST on storing R10 there?